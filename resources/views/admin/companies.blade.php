                                    ...
                                    <td class="px-6 py-4 text-sm">
                                        ...
                                        <div x-data="{ 
                                            ...
                                            <div class="flex items-center gap-2">
                                                <!-- Copy Link Button -->
                                                <button @click="copyToClipboard('{{ $company->access_url }}')" 
                                                    :class="copied ? 'bg-green-600 hover:bg-green-700' : 'bg-blue-600 hover:bg-blue-700'"
                                                    class="flex items-center gap-1 px-3 py-1 text-white transition-colors rounded-lg">
                                                    <svg x-show="!copied" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                                    </svg>
                                                    <svg x-show="copied" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="display: none;">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                                    </svg>
                                                    <span x-text="copied ? 'Copied!' : 'CopyLink'"></span>
                                                </button>
