...
<head>
    ...
    <title>{{ config('app.name', 'Career Fair DCS') }} - @yield('title', 'Student')</title>
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="hidden sm:flex items-center space-x-2">
                        ...
                        <span class="px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300">
                            Student
                        </span>
                    </div>
